...
export default function Products() {
    ...
    const products = [
        {name:'tablet1', price:45, category:'تبلت', img:'tab1.jpg'},
        {name:'tablet2', price:54, category:'تبلت', img:'tab3.png'},
        {name:'tablet3', price:61, category:'تبلت', img:'tab4.jpg'},
        {name:'tablet4', price:32, category:'تبلت', img:'tab5.jpg'},
        {name:'laptop1', price:120, category:'لبتاب', img:'laptop1.jpeg'},
        {name:'laptop2', price:243, category:'لبتاب', img:'laptop2.jpg'},
        {name:'laptop3', price:200, category:'لبتاب', img:'laptop3.jpg'},
        {name:'laptop4', price:180, category:'لبتاب', img:'laptop4.jpg'},
        {name:'mobile1', price:56, category:'موبایل', img:'mobile1.png'},
        {name:'mobile2', price:76, category:'موبایل', img:'mobile2.jpg'},
        {name:'mobile3', price:40, category:'موبایل', img:'mobile3.jpg'},
        {name:'mobile4', price:90, category:'موبایل', img:'mobile5.jpg'},
    ]
    ...
    <div className="mb-8 w-10/12 mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 p-6">
        ...
        <div className="relative group overflow-hidden rounded shadow">
           ...
           group-hover:opacity-100 group-hover:scale-105 group-hover:brightness-75" alt={p.name} src={`${process.env.PUBLIC_URL}/photos/${p.img}`} />
